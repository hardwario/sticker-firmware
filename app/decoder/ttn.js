...
var _SENSOR_TYPES = {
  ...
  3: {
    ...
    ch: [
      { n: "temperature", u: "degC", k: "threshold", s: 100, h: ["i16", 100] },
      { n: "humidity", u: "%RH", k: "threshold", s: 2, h: ["u8", 2] },
      { n: "temperature-aux", u: "degC", k: "threshold", s: 100, h: ["i16", 100] },
      { n: "illuminance", u: "lx", k: "threshold", s: 1, h: ["u16", 0.5] },
      { n: "magnetic-field", u: "mT", k: "threshold", s: 1000, h: ["i16", 100] },
      { n: "tilt", u: "bool", k: "state", s: 1, h: ["u8", 1] },
      { n: "accel-x", u: "m/s2", k: "threshold", s: 100, h: ["i16", 100] },
      { n: "accel-y", u: "m/s2", k: "threshold", s: 100, h: ["i16", 100] },
      { n: "accel-z", u: "m/s2", k: "threshold", s: 100, h: ["i16", 100] }
    ]
  }
};
