...
void app_nfc_ingest(const NfcConfigMessage *message)
{
	...
	if (message->has_application) {
		if (message->application.has_calibration) {
			LOG_INF_PARAM_BOOL("application.calibration", message->application.calibration);
			config->calibration = message->application.calibration;
		}

		if (message->application.has_interval_sample) {
			LOG_INF_PARAM_INT("application.interval_sample", message->application.interval_sample);
			config->interval_sample = message->application.interval_sample;
		}

		if (message->application.has_interval_report) {
			LOG_INF_PARAM_INT("application.interval_report", message->application.interval_report);
			config->interval_report = message->application.interval_report;
		}

		if (message->application.has_alarm_temperature_enabled) {
			LOG_INF_PARAM_BOOL("application.alarm_temperature_enabled", message->application.alarm_temperature_enabled);
		...
		if (message->application.has_alarm_t1_temperature_lo) {
			LOG_INF_PARAM_FLOAT("application.alarm_t1_temperature_lo", message->application.alarm_t1_temperature_lo);
		...
		if (message->application.has_alarm_t1_temperature_hi) {
			LOG_INF_PARAM_FLOAT("application.alarm_t1_temperature_hi", message->application.alarm_t1_temperature_hi);
		...
		if (message->application.has_alarm_t1_temperature_hst) {
			LOG_INF_PARAM_FLOAT("application.alarm_t1_temperature_hst", message->application.alarm_t1_temperature_hst);
		...
		if (message->application.has_alarm_t2_temperature_enabled) {
			LOG_INF_PARAM_BOOL("application.alarm_t2_temperature_enabled", message->application.alarm_t2_temperature_enabled);
		...
		if (message->application.has_alarm_t2_temperature_lo) {
			LOG_INF_PARAM_FLOAT("application.alarm_t2_temperature_lo", message->application.alarm_t2_temperature_lo);
		...
		if (message->application.has_alarm_t2_temperature_hi) {
			LOG_INF_PARAM_FLOAT("application.alarm_t2_temperature_hi", message->application.alarm_t2_temperature_hi);
