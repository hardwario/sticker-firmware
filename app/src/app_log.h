...
#define LOG_ERR_CALL_FAILED_CTX_INT(func, ctx, val) LOG_ERR("Call `" func "` failed (" ctx "): %d", val)
#define LOG_ERR_CALL_FAILED_CTX_STR(func, ctx, val) LOG_ERR("Call `" func "` failed (" ctx "): %s", val)
...
#define LOG_INF_PARAM_INT(name, value) \
	LOG_INF("Parameter `" name "`: %d", (value))
#define LOG_INF_PARAM_FLOAT(name, value) \
	LOG_INF("Parameter `" name "`: %.2f", (double)(value))
#define LOG_INF_PARAM_STR(name, value) \
	LOG_INF("Parameter `" name "`: %s", (value))
#else
#define LOG_INF_PARAM_BOOL(name, value)
#define LOG_INF_PARAM_INT(name, value)
#define LOG_INF_PARAM_FLOAT(name, value)
